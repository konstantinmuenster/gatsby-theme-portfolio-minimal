---
title: 'This is my first article on this blog.'
description: 'This is an exemplary file to show how Markdown can be used as a local data source for articles.'
author: 'Konstantin Münster'
date: '2021-05-28'
banner:
    src: '../../images/kelly-sikkema-Hl3LUdyKRic-unsplash.jpg'
    alt: 'First Markdown Post'
    caption: 'Photo by [Florian Olivo](https://unsplash.com/photos/Nc5Q_CEcY44)'
categories:
    - 'Setup'
    - 'Tutorial'
keywords:
